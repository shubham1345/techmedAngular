...
export class ParticipantsComponent {
  ...
  videoCompose: any
  roomSid: any
  constructor(private readonly renderer: Renderer2, private readonly videoChatService: VideoChatService, private svcLocalstorage: SvclocalstorageService
  ...
  onEndCall()
  {
      ...
      this.roomname = this.svcLocalstorage.GetData(environment.RoomName)
      this.videoChatService.endVideoCall(this.roomname).subscribe(data =>
        {
            this.roomInfo = data;
                   
        });
        // console.log(this.svcLocalstorage.GetData(environment.RoomSid))
        // this.videoChatService.ComposeCallRecording(this.roomname, location.origin).subscribe(data =>
        // {
        //    this.videoCompose = data;
        // })
        // console.log(this.videoCompose)
