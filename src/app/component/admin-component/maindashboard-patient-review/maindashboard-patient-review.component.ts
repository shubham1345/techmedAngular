...
@Component({
  selector: 'app-maindashboard-patient-review',
  templateUrl: './maindashboard-patient-review.component.html',
  styleUrls: ['./maindashboard-patient-review.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class MaindashboardPatientReviewComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.ReportName = 'Patient Review Report';

    this._sweetAlert.getLoader().subscribe((res: any) => {
      this.loading = res;
      console.log('patient review', this.loading);
    });
    ...
    // this.GetReviewPatientReportWithRestrictedAccess({
    //   params,
    // });
    // this.GetReviewPatientReport({
    //   params,
    // });
    //////////////////////////////////////////////////////////////
  ...
  GetReviewPatientReportWithRestrictedAccess(params: any) {
    this.userObjFromToken = this.svcLocalstorage.GetData(
      environment.AuthTokenKeyLSKey
    );
    // GetReviewPatientReport(params: any) {
    //   this.userObjFromToken = this.svcLocalstorage.GetData(
    //     environment.AuthTokenKeyLSKey
    //   );
    if (this.userObjFromToken) {
      this.loading = true;
      this.Svc_dashboardService.GetReviewPatientReportWithRestrictedAccess(
        params
      ).subscribe(
        (data: any) => {
          this.loading = false;
          console.log(
            data,
            'this is GetReviewPatientReportWithRestrictedAccess data'
          );
      ...
      // this.Svc_dashboardService.GetReviewPatientReport(params).subscribe(
      //   (data: any) => {
      //     this.loading=false
      //     console.log(data, 'this is GetReviewPatientReport data');
      //     this.ELEMENT_DATA = data;
      //     this.dataSourceDownload = this.ELEMENT_DATA;
      //     console.log(
      //       this.ELEMENT_DATA,
      //       'this is GetReviewPatientReport data'
      //     );
      //     this.dataSource = new MatTableDataSource<PeriodicElement>(
      //       this.ELEMENT_DATA
      //     );
    ...
    if (value == 'Excel') {
      ...
      const newArrayOfObj = this.dataSourceDownload.map((item) => {
        return {
          ...
          'Review Date': this.datepipe.transform(item.reviewDate, 'dd-MM-yyyy'),
