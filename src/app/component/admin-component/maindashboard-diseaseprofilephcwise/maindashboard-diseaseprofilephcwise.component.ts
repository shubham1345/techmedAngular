...
@Component({
  selector: 'app-maindashboard-diseaseprofilephcwise',
  templateUrl: './maindashboard-diseaseprofilephcwise.component.html',
  styleUrls: ['./maindashboard-diseaseprofilephcwise.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class MaindashboardDiseaseprofilephcwiseComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.ReportName = 'Disease Profile PHC Wise';
    ...
    // this.GetDashboardDiseasephcWiseWithRestrictedAccess({
    //   params,
    // });
    // this.GetDashboardDiseasephcWise({
    //   params,
    // });
    //////////////////////////////////////////////////////////////
    this.dataSource.filterPredicate = ((data, filter) => {
      ...
      const e = !filter.disease || data.disease.toLowerCase().includes(filter.disease);
  ...
  GetDashboardDiseasephcWiseWithRestrictedAccess(params: any) {
    this.userObjFromToken = this.svcLocalstorage.GetData(
      environment.AuthTokenKeyLSKey
    );
  // GetDashboardDiseasephcWise(params: any) {
  //   this.userObjFromToken = this.svcLocalstorage.GetData(
  //     environment.AuthTokenKeyLSKey
  //   );
    if (this.userObjFromToken) {
    this.loading=true
      this.Svc_dashboardService.GetDashboardDiseasephcWiseWithRestrictedAccess(params).subscribe(
        (data: any) => {
          this.loading=false
          console.log(data, 'this is GetDashboardDiseasephcWiseWithRestrictedAccess data');
          ...
          console.log(
            this.ELEMENT_DATA,
            'this is GetDashboardDiseasephcWiseWithRestrictedAccess data'
          );
      ...
      // this.Svc_dashboardService.GetDashboardDiseasephcWise(params).subscribe(
      //   (data: any) => {
      //     this.loading=false
      //     console.log(data, 'this is GetDashboardDiseasephcWise data');
      //     this.ELEMENT_DATA = data;
      //     this.HeaderData = data;
      //     this.dataSourceDownload = this.ELEMENT_DATA;
      //     this.isValid=true;
      //     console.log(
      //       this.ELEMENT_DATA,
      //       'this is GetDashboardDiseasephcWise data'
      //     );
      //     this.dataSource = new MatTableDataSource<PeriodicElement>(
      //       this.ELEMENT_DATA
      //     );
