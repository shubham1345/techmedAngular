...
@Component({
  selector: 'app-maindashboard-medprescribedgenericwise',
  templateUrl: './maindashboard-medprescribedgenericwise.component.html',
  styleUrls: ['./maindashboard-medprescribedgenericwise.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class MaindashboardMedprescribedgenericwiseComponent implements AfterViewInit {
  loading = false;
  ...
  constructor(
    ...
    this.ReportName = 'Generic Wise Medicine Prescribed';
    ...
    // this.GetPrescribedMedicineWithRestrictedAccess({
    //   params,
    // });
    ...
    this.dataSource.filterPredicate = ((data, filter) => {
      //const a = !filter.numberOfTimePrescribed || data.numberOfTimePrescribed === filter.numberOfTimePrescribed;
      const b =
        !filter.prescribedMedicine ||
        data.prescribedMedicine.toLowerCase().includes(filter.prescribedMedicine);
  ...
  GetPrescribedMedicineWithRestrictedAccess(params: any) {
    this.loading=true
    this.userObjFromToken = this.svcLocalstorage.GetData(
      environment.AuthTokenKeyLSKey
    );
  // GetPrescribedMedicine(params: any) {
  //   this.loading=true
  //   this.userObjFromToken = this.svcLocalstorage.GetData(
  //     environment.AuthTokenKeyLSKey
  //   );
    if (this.userObjFromToken) {
      this.Svc_dashboardService.GetPrescribedMedicineWithRestrictedAccess(params).subscribe(
        (data: any) => {
          this.loading=false;
          console.log(data, 'this is GetPrescribedMedicineWithRestrictedAccess data');
          ...
          console.log(
            this.ELEMENT_DATA,
            'this is GetPrescribedMedicineWithRestrictedAccess data'
          );
          ...
          this.dataSource.filterPredicate = ((data, filter) => {
            ...
            const b =
              !filter.prescribedMedicine ||
              data.prescribedMedicine.toLowerCase().includes(filter.prescribedMedicine.toLowerCase());
      ...
      // this.Svc_dashboardService.GetPrescribedMedicine(params).subscribe(
      //   (data: any) => {
      //     this.loading=false;
      //     console.log(data, 'this is GetPrescribedMedicine data');
      //     this.ELEMENT_DATA = data;
      //     this.HeaderData = data;
      //     this.dataSourceDownload = this.ELEMENT_DATA;
      //     this.isValid=true;
      //     console.log(
      //       this.ELEMENT_DATA,
      //       'this is GetPrescribedMedicine data'
      //     );
      //     this.dataSource = new MatTableDataSource<PeriodicElement>(
      //       this.ELEMENT_DATA
      //     );
  ...
  public Download(value: any) {
    ...
    if (value == 'Excel') {
      ...
      const newArrayOfObj = this.dataSourceDownload.map(item => {
        return {
         'SL No.':item.srNo ,'Generic':item.prescribedMedicine,'No. Of Time Prescribed':item.numberOfTimePrescribed};
      });
