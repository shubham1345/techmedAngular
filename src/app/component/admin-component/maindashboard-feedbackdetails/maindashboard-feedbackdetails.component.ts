...
@Component({
  selector: 'app-maindashboard-feedbackdetails',
  templateUrl: './maindashboard-feedbackdetails.component.html',
  styleUrls: ['./maindashboard-feedbackdetails.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class MaindashboardFeedbackdetailsComponent implements AfterViewInit {
  loading = false;
  ...
  constructor(
    ...
    // this.GetDashboardFeedbackReportWithRestrictedAccess({
    //   params,
    // });
    // this.GetDashboardFeedbackReport({
    //   params,
    // });
    //////////////////////////////////////////////////////////////
    this.dataSource.filterPredicate = ((data, filter) => {
      ...
      const g = !filter.doctorName || data.doctorName.toLowerCase().includes(filter.doctorName);
      const h =
      //  !filter.feedback || data.feedback.toLowerCase().includes(filter.feedback);
      !filter.feedback || data.feedback === filter.feedback;
  ...
  GetDashboardFeedbackReportWithRestrictedAccess(params: any) {
    this.loading=true;
    this.userObjFromToken = this.svcLocalstorage.GetData(
      environment.AuthTokenKeyLSKey
    );
  // GetDashboardFeedbackReport(params: any) {
  //   this.loading=true;
  //   this.userObjFromToken = this.svcLocalstorage.GetData(
  //     environment.AuthTokenKeyLSKey
  //   );
    if (this.userObjFromToken) {
      this.Svc_dashboardService.GetDashboardFeedbackReportWithRestrictedAccess(params).subscribe(
        (data: any) => {
          this.loading=false;
          console.log(data, 'this is GetDashboardFeedbackReportWithRestrictedAccess data');
          ...
          console.log(
            this.ELEMENT_DATA,
            'this is GetDashboardFeedbackReportWithRestrictedAccess data'
          );
          ...
          this.dataSource.filterPredicate = ((data, filter) => {
            ...
            const g = !filter.doctorName || data.doctorName.toLowerCase().includes(filter.doctorName.toLowerCase());
            const h =
            //  !filter.feedback || data.feedback.toLowerCase().includes(filter.feedback.toLowerCase());
             !filter.feedback || data.feedback === filter.feedback;
      ...
      // this.Svc_dashboardService.GetDashboardFeedbackReport(params).subscribe(
      //   (data: any) => {
      //     this.loading=false;
